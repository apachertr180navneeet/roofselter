...
<div class="space-y-6">
    <div class="admin-card">
        <div class="admin-card-header">
            <h3 class="text-base font-semibold text-gray-900">FAQ Info</h3>
            <a href="{{route('admin.service-faq-create')}}" class="admin-btn-primary ml-auto"><i class="fa fa-plus"></i> Add FAQ</a>
        </div>
