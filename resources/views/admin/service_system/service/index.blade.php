            ...
            <table class="admin-table" id="basic-datatables">
                ...
                <tbody>
                    ...
                    <tr id="record-row-{{ $service->id }}">
                        ...
                        <td>
                            <div class="w-10 h-10">
                                <img src="{{asset($service->image ? 'img/'.$service->image : '../panel-assets/assets/img/placeholder-image-3.jpg')}}" alt="{{ $service->title }}" class="rounded object-cover w-full h-full">
                            </div>
                        </td>
                        <th scope="row">
