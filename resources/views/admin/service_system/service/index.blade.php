            ...
            <table class="admin-table" id="basic-datatables">
                ...
                <tbody>
                    ...
                    <tr id="record-row-{{ $service->id }}">
                        ...
                        <td>
                            <div class="w-10 h-10">
                                <img src="{{ $service->image && file_exists(public_path('img/'.$service->image)) ? asset('img/'.$service->image) : asset('panel-assets/assets/img/placeholder-image.svg') }}" alt="{{ $service->title }}" class="rounded object-cover w-full h-full">
                            </div>
                        </td>
                        <td>
                        ...
                        <td>{{ $service->short_description ? $service->short_description : '--' }}</td>
                        <td class="text-left">
                            <label class="switch">
