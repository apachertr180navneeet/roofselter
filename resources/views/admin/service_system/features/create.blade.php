    ...
    <div class="max-w-4xl mx-auto">
      <div class="admin-card">
        <div class="admin-card-header">
          <h3 class="text-base font-semibold text-gray-900">Add Features Record for Your Services</h3>
        </div>
        <form action="{{route('admin.service-features-store')}}" method="post" enctype="multipart/form-data">
          @csrf
