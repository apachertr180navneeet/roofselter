...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('panel-assets/assets/css/file-upload.css') }}">
...
<script src="{{asset('panel-assets/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js')}}"></script>
<script src="{{asset('panel-assets/assets/js/plugin/chart.js/chart.min.js')}}"></script>
<script src="{{asset('panel-assets/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js')}}"></script>
<script src="{{asset('panel-assets/assets/js/plugin/chart-circle/circles.min.js')}}"></script>
<script src="{{asset('panel-assets/assets/js/plugin/datatables/datatables.min.js')}}"></script>
<script src="{{asset('panel-assets/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js')}}"></script>
<script src="{{asset('panel-assets/assets/js/plugin/jsvectormap/jsvectormap.min.js')}}"></script>
<script src="{{asset('panel-assets/assets/js/plugin/jsvectormap/world.js')}}"></script>
<script src="{{asset('panel-assets/assets/js/plugin/sweetalert/sweetalert.min.js')}}"></script>
<script src="{{ asset('panel-assets/assets/js/file-upload.js') }}"></script>
...
$(document).ready(function () {
    ...
    function loadIcons(selected) {
        $.getJSON("{{ asset('panel-assets/assets/icons.json') }}", function (data) {
    ...
    function fetchCounts() {
        $.get("{{ url('/admin/enquiries/latest') }}", function (data) {
            ...
            if (data.count > lastCount) {
                if (Notification.permission === "granted") new Notification("New Enquiry!", { body: "You have a new enquiry.", icon: "{{ asset('panel-assets/icon.png') }}" });
                new Audio("{{ asset('panel-assets/sounds/notify.mp3') }}").play();
            }
