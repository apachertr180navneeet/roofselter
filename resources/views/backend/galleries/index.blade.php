                            ...
                            <tr id="record-row-{{ $gallery->id }}">
                                ...
                                <td class="text-center">
                                    <div class="inline-flex">
                                        <img src="{{ asset($gallery->image ? 'img/'.$gallery->image : '../assets/img/placeholder-image-3.jpg') }}" alt="{{ $gallery->caption }}" class="rounded-lg object-cover" style="width:80px;height:60px;object-fit:cover;">
                                    </div>
                                </td>
