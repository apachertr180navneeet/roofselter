        ...
        <div class="main-header">
          ...
          >
            <div class="container-fluid">
              <nav
                class="navbar navbar-header-left navbar-expand-lg navbar-form nav-search p-0 d-none"
              >
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-icon dropdown hidden-caret">
                  <a class="nav-link dropdown-toggle" href="#" id="notifDropdown" role="button"
                     data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <span class="notification" id="header-enquiry-count">0</span>
                  </a>
                  <ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
                      <li>
                          <div class="dropdown-title">
                              You have <span id="notif-total">0</span> new notifications
                          </div>
                      </li>
                      <li>
                          <div class="notif-scroll scrollbar-outer">
                              <div class="notif-center" id="notif-list">
                                  <!-- Ajax ke through fill hoga -->
                              </div>
                          </div>
                      </li>
                      <li>
                          <a class="see-all" href="{{ route('admin.enquiries') }}">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="{{asset('img/'.Auth::guard('admin')->user()->image)}}"
                        alt="..."
