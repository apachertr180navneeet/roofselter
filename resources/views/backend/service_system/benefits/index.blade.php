...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Service Benefits</h3>
                ...
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            <div class="card-title">Benefits Info</div>
                            <a href="{{route('admin.service-benefits-create')}}" class="btn btn-dark ms-auto"><i class="fa fa-plus"></i> Add Benefits</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr id="record-row-{{ $benefits->id }}">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <i class="fa {{ $benefits->icon }} me-2"></i>{{ $benefits->icon }}
                                        </td>
