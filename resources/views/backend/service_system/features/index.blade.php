                ...
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            <div class="card-title">Features Info</div>
                            <a href="{{route('admin.service-features-create')}}" class="btn btn-dark ms-auto"><i class="fa fa-plus"></i> Add Features</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr id="record-row-{{ $features->id }}">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <i class="fa {{ $features->icon }} me-2"></i>{{ $features->icon }}
                                        </td>
