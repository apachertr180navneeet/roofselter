...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Project Categories</h3>
        ...
        <div class="row">
                ...
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            <div class="card-title">Projects Category Info</div>
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Add Record for Projects Posts Category</div>
                  </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                  ...
                                  <small id="cat_nameHelp2" class="form-text text-muted"
                                          >This Category name your Projects Category Name.
                                  </small>
