                ...
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            <div class="card-title">Projects Info</div>
                            <a href="{{route('admin.blog-create')}}" class="btn btn-dark ms-auto"><i class="fa fa-plus"></i> Add Projects</a>
                            <!-- <button
                                ...
                                <tbody>
                                    ...
                                    <tr id="record-row-{{ $blog->id }}">
                                        ...
                                        <td>
                                            <p class="demo">
                                            <div class="avatar">
                                                <img src="{{asset($blog->image ? 'img/'.$blog->image : '../assets/img/placeholder-image-3.jpg')}}" alt="{{ $blog->title }}" class="avatar-img rounded">
                                            </div>
                                            </p>
                                        </td>
                                        <th scope="row">
                                        ...
                                        <td class="text-end d-none">{{ $blog->short_description ? $blog->short_description : '--' }}</td>
