...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Industry Features</h3>
                ...
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            <div class="card-title">Industry Features Info</div>
                            <a href="{{route('admin.industry-features-create')}}" class="btn btn-dark ms-auto"><i class="fa fa-plus"></i> Add Industry Features</a>
                        </div>
                    </div>
