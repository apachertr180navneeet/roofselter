                ...
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            <div class="card-title">Testimonial Info</div>
                            <a href="{{route('admin.testimonial-create')}}" class="btn btn-dark ms-auto"><i class="fa fa-plus"></i> Add Testimonial</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr id="record-row-{{ $testimonial->id }}">
                                        ...
                                        <td>
                                            <p class="demo">
                                            <div class="avatar">
                                                <img src="{{asset($testimonial->image ? 'img/'.$testimonial->image : '../assets/img/placeholder-image-3.jpg')}}" alt="{{ $testimonial->title }}" class="avatar-img rounded">
                                            </div>
                                            </p>
                                        </td>
                                        <th scope="row">
