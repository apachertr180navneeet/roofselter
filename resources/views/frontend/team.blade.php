...
@section('meta_title', 'Our Team | ' . (get_setting('website_name') ?: 'RoofShelter'))
...
<section class="relative py-20 md:py-28 bg-navy-800 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-5xl font-extrabold text-white">Our Team</h1>
        <div class="flex items-center justify-center gap-2 mt-4 text-sm">
            ...
            <span class="text-brand-400">Team</span>
        </div>
    </div>
</section>
...
<section class="section-padding bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14 animate-on-scroll">
            ...
            <h2 class="text-3xl md:text-4xl font-extrabold text-navy-800 mt-3">Meet Our Expert Team</h2>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="col-span-full text-center py-12">
                <h4 class="text-xl font-bold text-navy-800">No team members added yet.</h4>
