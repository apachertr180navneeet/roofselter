...
@section('title', get_setting('cms_services_meta_title', 'Services') . ' | ' . get_setting('website_name', 'RoofShelter'))
...
<section class="float-left w-100 service-location-con position-relative padding-top padding-bottom main-box">
    <div class="main-container">
        <div class="heading-title-con text-center">
            <span class="special-text d-block wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.05s">{{ get_setting('cms_services_regions_subtitle', 'Service Locations') }}</span>
            <h2 class="text-size-60 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.05s">{!! nl2br(e(get_setting('cms_services_regions_heading', 'Service Regions Across the Phoenix Area'))) !!}</h2>
            <p>{{ get_setting('cms_services_regions_description', 'Full mobilization available across the Phoenix Metropolitan Area.') }}</p>
        </div>
        <div class="row">
