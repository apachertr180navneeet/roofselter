...
class BlogCategoryController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($validator->passes()){
            ...
            return redirect()->back()->with('success','Projects Category Data Added Successfully');
        }else{
    ...
    public function update(Request $request, $id){
        ...
        if($validator->passes()){
            ...
            return redirect()->route('admin.blog-category')->with('success','Projects Category Data Updated Successfully');
        }else{
            return redirect()->back()->withInput()->withErrors($validator);
        }
    }
