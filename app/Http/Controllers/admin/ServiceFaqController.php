...
class ServiceFaqController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.service_system.faq.index',compact('service_faq'));
    }

    //This method will show listing a services faq
    public function create(){
        $service_info = Service::where('status',1)->get();
        return view('admin.service_system.faq.create',compact('service_info'));
    }
    ...
    public function edit($id){
        ...
        $service_info = Service::where('status',1)->get();
        return view('admin.service_system.faq.edit',compact('service_faq','service_info'));
    }
